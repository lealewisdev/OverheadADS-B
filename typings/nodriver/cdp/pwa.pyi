...
def get_os_app_state(manifest_id: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[int, typing.List[FileHandler]]]:
    '''
...
def install(manifest_id: str, install_url_or_bundle_url: typing.Optional[str] = ...) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    '''
...
def launch(manifest_id: str, url: typing.Optional[str] = ...) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, target.TargetID]:
    '''
...
def launch_files_in_app(manifest_id: str, files: typing.List[str]) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.List[target.TargetID]]:
    '''
...
def change_app_user_settings(manifest_id: str, link_capturing: typing.Optional[bool] = ..., display_mode: typing.Optional[DisplayMode] = ...) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    '''
