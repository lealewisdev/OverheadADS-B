...
RAD_NMI = os.getenv("RAD_NMI", "4")

POLL_INT = float(os.getenv("POLL_INT", "10"))
HTTP_TIMEOUT = float(os.getenv("HTTP_TIMEOUT", "5"))

OWNER_POLL_CACHE_MAX = float(os.getenv("HTTP_TIMEOUT", "5000"))

ADSBFI_URL = f"https://opendata.adsb.fi/api/v3/lat/{LAT}/lon/{LON}/dist/{RAD_NMI}"
HEXDB_URL = "https://hexdb.io/api/v1/aircraft/"
FR24_URL = "https://www.flightradar24.com/data/aircraft"

SQUAWKS_CSV = "src/overheadadsb/data/uk_squawks.csv"
